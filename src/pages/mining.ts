...
class MiningView extends DestructableView{
	...
	constructor(container : string){
		...
		if(!config.testnet) {
			...
			this.miningAddressesAvailable.push({
                address: 'hozYenRVzuxGxSfJWrJgLqTwtmjSvE4NDQFiPK25zPb4DJP5ZtFYDyDXJV9MAZ6PtqPBQdaeXHNEAVf6qsmpnCsR1ytmJnkY1d',
				label: 'Donation - HospitalCoin'
			});
			this.miningAddressesAvailable.push({
                address: 'hozYenRVzuxGxSfJWrJgLqTwtmjSvE4NDQFiPK25zPb4DJP5ZtFYDyDXJV9MAZ6PtqPBQdaeXHNEAVf6qsmpnCsR1ytmJnkY1d',
                label: 'Donation - HospitalCoin exchange listing'
			});
	...
	start(){
		...
		this.pool = new Pool(
            config.testnet ? 'ws://testnet.hospitalcoin.net:8080' : 'wss://hospitalcoin.net/mining',
